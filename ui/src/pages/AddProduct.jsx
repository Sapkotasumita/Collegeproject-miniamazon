...
const AddProduct = () => {
  ...
  const addProduct = async (values) => {
    ...
    try {
      ...
      console.log("Response data: ", res?.data); // Debugging: Check response from backend

      // Navigate back to the home page or products page
      navigate("/");
              ...
              >
                ...
                <VisuallyHiddenInput
                  ...
                  onChange={(event) => {
                    ...
                    console.log(imageLocalUrl); // Debugging: Check local URL of the image
